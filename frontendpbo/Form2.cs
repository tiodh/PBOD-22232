...
namespace frontendpbo
{
    public partial class Form2 : Form
    {
        ...
        {
            openChildForm(new DetailPengguna());
        }
        ...
        private void tempatMakan_Click(object sender, EventArgs e)
        {
            ...
            openChildForm(new DetailTempatMakan());
        ...
        {
            openChildForm(new CRUDTempatMakan());
        }
        ...
        {
            openChildForm(new DetailKeselamatan());
            showSubMenu(edit10);
        }
        ...
        {
            openChildForm(new CRUDDataInformasi());
        ...
        {
            openChildForm(new CRUPengunjung());
        }
